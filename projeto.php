...
<section class="our-skills" id="skill">
  <h1 class="text-center"><i style="font-size: 76px;" class="fa fa-pencil-square-o icone" aria-hidden="true"></i> O Projeto</h1>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="video ">
					<iframe src="https://player.vimeo.com/video/168579924?title=0&byline=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
			</div>
			<div class="col-lg-6 col-md-6">
				<ul class='skills'>
        ...
        <div class="row" style="margin-top:2.5%;">
          <div class="col-sm-9 col-sm-offset-2 margins" data-wow-duration="1000ms" data-wow-delay="300ms">
            <div class="col-sm-4">
